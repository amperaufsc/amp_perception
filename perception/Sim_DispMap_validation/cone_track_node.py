...
class Cone_Track_Process(Node):
    ...
    def __init__(self):
        ...
        endereco_matriz_intrinsica_left = '/home/otaviogoulart/ws/src/asp_perception/perception/config/fsds_left.yaml'
    ...
    def sync_callback(self, imgL_raw_ros_msg, imgR_raw_ros_msg, yoloinference):
        ...
        track_stamped = self.Track_Stamped_Msg_Pub(track, imgL_raw_ros_msg.header)
